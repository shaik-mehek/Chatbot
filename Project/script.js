function handleUserInput() {
    ...
    if (userInput === "") {
        chatOutput.innerHTML += `<div class="bot-message">Please enter a programming language to search.</div>`;
        return;
    }
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            if (data.extract) {
                ...
                chatOutput.innerHTML += `<div class="bot-message">Sorry, I couldn't find information on "${query}".</div>`;
            }
            chatOutput.scrollTop = chatOutput.scrollHeight;
        })
        .catch(error => {
